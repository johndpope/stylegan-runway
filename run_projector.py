...
def project_image(proj, targets, png_prefix, num_snapshots, reset=False):
    ...
    if not reset:
        proj._dlatent_avg = tflib.run(proj._dlatents_var)
...
_examples = '''examples:
  ...
  ipython run_projector.py -- project-real-images --network='/home/romain/win_desk/stylegan2/results/00093-stylegan2-feuilles1k-1gpu-config-e/network-snapshot-000240.pkl' --data-dir=./tfrecords/ --dataset=samples --num-snapshots=300 --num-images=10
