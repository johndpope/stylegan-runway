...
_valid_configs = [
    ...
    'config-2k', # feuilles dataset 2048-1024
    'config-1k',
...
def run(dataset, data_dir, result_dir, config_id, num_gpus, total_kimg, gamma, mirror_augment, metrics):
    ...
    sched.G_lrate_base = sched.D_lrate_base = 0.00127 # 0.002
    sched.minibatch_size_base = 8 #2 - 2k
    sched.minibatch_gpu_base = 8  #2 - 2k
    D_loss.gamma = 10
    ...
    if config_id == 'config-2k':
        sched.lod_initial_resolution = 8
        sched.G_lrate_base = sched.D_lrate_base = 0.001
        sched.G_lrate_dict = sched.D_lrate_dict = {128: 0.0015, 256: 0.002, 512: 0.003, 1024: 0.003, 2048: 0.004}
        sched.minibatch_size_base = 1 # (default)
        sched.minibatch_size_dict = {2: 128, 4: 64, 8: 32, 16: 16, 32: 8, 64: 4, 128: 2, 256: 1, 512: 1, 1024: 1, 2048: 1}
        sched.minibatch_gpu_base = 1 # (default)
        sched.minibatch_gpu_dict = {8: 1, 16: 1, 32: 1, 64: 1}
        #G.synthesis_func = 'G_synthesis_stylegan_revised'
        D.func_name = 'training.networks_stylegan2.D_stylegan'

    if config_id == 'config-1k':
        sched.lod_initial_resolution = 8
        sched.G_lrate_base = sched.D_lrate_base = 0.001
        sched.G_lrate_dict = sched.D_lrate_dict = {128: 0.0015, 256: 0.002, 512: 0.003, 1024: 0.003}
        sched.minibatch_size_base = 1 # (default)
        sched.minibatch_size_dict = {2: 128, 4: 64, 8: 32, 16: 16, 32: 8, 64: 4, 128: 2, 256: 1, 512: 1, 1024: 1}
        sched.minibatch_gpu_base = 1 # (default)
        sched.minibatch_gpu_dict = {8: 1, 16: 1, 32: 1, 64: 1}
        G.synthesis_func = 'G_synthesis_stylegan_revised'
        D.func_name = 'training.networks_stylegan2k.D_stylegan'
